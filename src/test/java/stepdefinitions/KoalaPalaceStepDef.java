...
public class KoalaPalaceStepDef {
    ...
    @Then("kullanici hotellist bolumunundeki kayit bulunamadi yazisini gorur")
    public void kullanici_hotellist_bolumunundeki_kayit_bulunamadi_yazisini_gorur() {
        Assert.assertTrue(page.hotelCreateKayitOlamadiz.isDisplayed());
    }
